...
func Test_headCommand(t *testing.T) {
	cases := map[string]struct {
		...
		"delete key1":                 {In: "amagami-_.0", Expected: &entity.Header{Key: "amagami-_.0", NeedToDelete: true}},
		"delete key2":                 {In: "rihoko=", Expected: &entity.Header{Key: "rihoko", Val: "", NeedToDelete: true}},
	}
