...
var protoDefaults = map[descriptorpb.FieldDescriptorProto_Type]interface{}{
	...
	descriptorpb.FieldDescriptorProto_TYPE_FIXED64:  uint64(0),
...
func convertValue(pv string, fieldType descriptorpb.FieldDescriptorProto_Type) (interface{}, error) {
	if pv == "" {
