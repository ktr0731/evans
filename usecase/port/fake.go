...
//             CallFunc: func(in1 *CallParams) (io.Reader, error) {
// 	               panic("TODO: mock out the Call method")
//             },
//             DescribeFunc: func(in1 *DescribeParams) (io.Reader, error) {
// 	               panic("TODO: mock out the Describe method")
//             },
//             HeaderFunc: func(in1 *HeaderParams) (io.Reader, error) {
// 	               panic("TODO: mock out the Header method")
//             },
//             PackageFunc: func(in1 *PackageParams) (io.Reader, error) {
// 	               panic("TODO: mock out the Package method")
//             },
//             ServiceFunc: func(in1 *ServiceParams) (io.Reader, error) {
// 	               panic("TODO: mock out the Service method")
//             },
//             ShowFunc: func(in1 *ShowParams) (io.Reader, error) {
...
// Call calls CallFunc.
func (mock *InputPortMock) Call(in1 *CallParams) (io.Reader, error) {
...
func (mock *InputPortMock) Describe(in1 *DescribeParams) (io.Reader, error) {
...
func (mock *InputPortMock) Header(in1 *HeaderParams) (io.Reader, error) {
...
func (mock *InputPortMock) Package(in1 *PackageParams) (io.Reader, error) {
...
func (mock *InputPortMock) Service(in1 *ServiceParams) (io.Reader, error) {
...
// Show calls ShowFunc.
func (mock *InputPortMock) Show(in1 *ShowParams) (io.Reader, error) {
...
// 	               panic("TODO: mock out the Call method")
//             },
//             DescribeFunc: func(showable Showable) (io.Reader, error) {
// 	               panic("TODO: mock out the Describe method")
//             },
...
// 	               panic("TODO: mock out the Service method")
//             },
//             ShowFunc: func(showable Showable) (io.Reader, error) {
// 	               panic("TODO: mock out the Show method")
//             },
//         }
//
...
// Describe calls DescribeFunc.
func (mock *OutputPortMock) Describe(showable Showable) (io.Reader, error) {
	if mock.DescribeFunc == nil {
...
// Show calls ShowFunc.
func (mock *OutputPortMock) Show(showable Showable) (io.Reader, error) {
	if mock.ShowFunc == nil {
